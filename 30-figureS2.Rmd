...
s2diversity = tcr_sample_metadata %>%
  ...
  left_join(read.csv("tmpdiversity.csv") %>%
...
d <- ggplot(GI, aes(plotgroup, slope))

(d <- ggplot(GI, aes(tissue, slope)) +
  geom_boxplot(aes(fill = allograft), alpha = 0.5) +
...
clonality_CMV = cc + geom_dotplot(binaxis = "y", stackdir = "center", binpositions="all", aes(fill = CMV.reactivation), dotsize = 1, stroke = 2, alpha = .8, position = jitter2) +
  theme_classic() + theme(axis.text=element_text(size=15, color = "black")) +
  theme(axis.text.y=element_text(size=12, color = "black"), legend.text = element_text(size = 12, color = "black"), legend.title = element_text(size = 15, color = "black"), axis.title = element_text(size = 15, color = "black", face = "bold")) +
  theme(axis.text.x = element_text(size = 12, hjust = 0, color = "black", angle = -30)) +
  scale_x_discrete(limits = c("esophagus", "stomach", "small intestine", "large intestine", "rectum", "liver", "skin", "spleen")) +
...
clonality_GVHD = cc + geom_dotplot(binaxis = "y", stackdir = "center", binpositions="all", aes(fill = GVHD_severity), dotsize = 1, stroke = 2, alpha = .8, position = jitter2) +
  theme_classic() + theme(axis.text=element_text(size=15, color = "black")) +
  theme(axis.text.y=element_text(size=12, color = "black"), legend.text = element_text(size = 12, color = "black"), legend.title = element_text(size = 15, color = "black"), axis.title = element_text(size = 15, color = "black", face = "bold")) +
  theme(axis.text.x = element_text(size = 12, hjust = 0, color = "black", angle = -30)) +
  scale_x_discrete(limits = c("esophagus", "stomach", "small intestine", "large intestine", "rectum", "liver", "skin", "spleen")) +
...
#this plot colors by allograft source
slope_graft = s + geom_dotplot(binaxis = "y", stackdir = "center", binpositions="all", aes(fill = allograft), dotsize = 1, stroke = 2, alpha = .8, position = jitter2) +
  theme_classic() + theme(axis.text=element_text(size=15, color = "black")) +
  theme(axis.text.y=element_text(size=12, color = "black"), legend.text = element_text(size = 12, color = "black"), legend.title = element_text(size = 15, color = "black"), axis.title = element_text(size = 15, color = "black", face = "bold")) +
  theme(axis.text.x = element_text(size = 12, hjust = 0, color = "black", angle = -30)) +
  scale_x_discrete(limits = c("esophagus", "stomach", "small intestine", "large intestine", "rectum", "liver", "skin", "spleen")) +
...
slope_CMV = ss + geom_dotplot(binaxis = "y", stackdir = "center", binpositions="all", aes(fill = CMV.reactivation), dotsize = 1, stroke = 2, alpha = .8, position = jitter2) +
  theme_classic() + theme(axis.text=element_text(size=15, color = "black")) +
  theme(axis.text.y=element_text(size=12, color = "black"), legend.text = element_text(size = 12, color = "black"), legend.title = element_text(size = 15, color = "black"), axis.title = element_text(size = 15, color = "black", face = "bold")) +
  theme(axis.text.x = element_text(size = 12, hjust = 0, color = "black", angle = -30)) +
  scale_x_discrete(limits = c("esophagus", "stomach", "small intestine", "large intestine", "rectum", "liver", "skin", "spleen")) +
...
#this plot colors by grade of GVHD peri-autopsy (acute GVHD)
slope_GVHD = ss + geom_dotplot(binaxis = "y", stackdir = "center", binpositions="all", aes(fill = GVHD_severity), dotsize = 1, stroke = 2, alpha = .8, position = jitter2) +
  theme_classic() + theme(axis.text=element_text(size=15, color = "black")) +
  theme(axis.text.y=element_text(size=12, color = "black"), legend.text = element_text(size = 12, color = "black"), legend.title = element_text(size = 15, color = "black"), axis.title = element_text(size = 15, color = "black", face = "bold")) +
  theme(axis.text.x = element_text(size = 12, hjust = 0, color = "black", angle = -30)) +
  scale_x_discrete(limits = c("esophagus", "stomach", "small intestine", "large intestine", "rectum", "liver", "skin", "spleen")) +

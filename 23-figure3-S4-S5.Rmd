...
plots_to_make <- list(
  ...
  "Recipient 7, rep2, day 14" = c(org="Mouse", ref_tissue="skin", topn=10, ref_color="forestgreen", f="S4A"),
   "Patient B" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4L"), 
  "Patient C" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4M"), 
  "Patient D" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4N"), 
  "Patient E" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4O"), 
  "Patient F" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4P"),
  "Patient G" = c(org="Human", topn=10, ref_tissue="graft_blood", ref_color="brightblue4", f="S4Q")
)

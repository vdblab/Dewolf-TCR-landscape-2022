...
ggsave(file = "scatterplot_ascending_descending.pdf", plot = scatterplot_ascending_descending, device = "pdf", height = 2, width = 2, units = "in")
...
ggsave(file = "scatterplot_ascending_skin.pdf", plot = scatterplot_ascending_skin, device = "pdf", height = 2, width = 2, units = "in")
ggsave(file = "scatterplot_ascending_duodenum.pdf", plot = scatterplot_ascending_duodenum, device = "pdf", height = 2, width = 2, units = "in")
...
ggsave(plot = wrap_plots(flattenlist(lapply(jsdplist, function(x){x[["single"]]})), ncol = 2), filename = file.path(figs_dir, str_glue("TCR_all_pat_trees.pdf")), height = 40, width = 15)

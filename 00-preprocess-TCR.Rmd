...
- wait patiently
- move downloaded zip to this repo, unpack, and rename the folder to `samples`


```{R}
tcr_data_dir <- "samples/"
```
...
if (!file.exists(tcr_raw_output)){
  raw_files <- sort(dir(tcr_data_dir, full.names = TRUE))
  ...
  write.csv(tcr_raw_original, file = tcr_raw_output, row.names = FALSE)
}
```
